...
Class definition header for the VCNL4010 chip from Vishay Semiconductors. This is a Fully Integrated Proximit and
and Ambient Light Sensor with Infrared Emitter, I2C Interface and Interrupt Function. The data sheet for the 
VCNL4010 can be found at http://www.vishay.com/docs/83462/vcnl4010.pdf and there is a breakout board from Adafruit
with additional information located at https://www.adafruit.com/product/466. \n\n
The most recent version of the library can be downloaded from https://github.com/SV-Zanshin/VCNL4010/archive/master.zip 
and a detailed description of the library and it's functions is at the github wiki located 
in https://github.com/SV-Zanshin/VCNL4010/wiki \n\n
