...
void loop() {                                                                 //                                  //
  ...
  int32_t  ambientSensorChange   = ambientSensorLast - ambientSensor;         // Compute the delta ALS            //
  int32_t  proximitySensorChange = proximityLast - proximitySensor;           // Compute the delta Proximity      //
                                                                              //                                  //
